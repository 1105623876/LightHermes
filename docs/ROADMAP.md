...
- **下一阶段不应继续堆记忆主线**：Phase 2.7 发版检查和 v0.3.4 收口已完成，更优路径是发布 v0.3.4，再进入 Phase 3 插件/工具生态或 Phase 4 深度性能优化。
...
## Phase 2.7: 发版准备与真实 API smoke test ✅ 已完成
...
### 开发节奏
- **先验证再发版**: Phase 2.7 发版检查和 v0.3.4 收口已完成，发布 v0.3.4 后再继续扩展功能
