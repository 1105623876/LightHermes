...
**Status:** 2026-08-09 已完成 P0 + 最小 P1；2026-08-13 完成来源读取与邻接展开。随后落地 P1 运行时协议（`judge_claim`、`absence`、`suggested_query`），并修正单 claim 回写、未检索 `no_evidence` 拒绝和 conflict 未决语义。全量 200/200。质量 A/B 不在本切片。
