...
**当前状态（2026-07-07）**: v0.3.4 收口完成，流式工具调用修复、记忆性能回归修复和版本文档同步已完成。
...
**下一步计划**:
- **优先**: 打 `v0.3.4` tag 并发布；如需更完整发布前验证，可再补 OpenAI/Anthropic 任一路径真实 smoke test
...
- v0.3.4 发版后进入插件系统与工具生态扩展；如需更完整发布前验证，可再补 OpenAI/Anthropic 任一路径真实 API smoke test
